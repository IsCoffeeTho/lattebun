...
test("Empty Template String", async () => {
	const testTemplate: LatteBun.Template = new lattebun.templateFile(`${__dirname}/files/empty.txt`);
...
test("No FillIn Template String", async () => {
	const testTemplate: LatteBun.Template = new lattebun.templateFile(`${__dirname}/files/nofill.txt`);
	testTemplateConstructor(testTemplate);
...
test("Simple Template File", async () => {
	const testTemplate: LatteBun.Template = new lattebun.templateFile(`${__dirname}/files/simple.txt`);
	testTemplateConstructor(testTemplate);
